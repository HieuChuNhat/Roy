          ...
          <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $product -> name }}</td>
                    <td><img src="{{ asset('assets/images/'.$product -> image.'') }}" width="70" height="70" alt=""></td>
                    <td>${{ $product -> price }}</td>
                    <td>{{ $product -> type }}</td>
                    <td><a href="{{ route('delete.products', ['id' => $product->id]) }}" class="btn btn-danger  text-center ">Delete</a></td>
                 </tr>
                @endforeach
