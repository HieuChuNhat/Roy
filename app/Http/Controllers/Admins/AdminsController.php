...
class AdminsController extends Controller
{
    ...
    public function deleteOrders($id){
        ...
        if($order){
            ...
            return Redirect::route('all.orders')->with(['delete'=>"order status deleted succesffully"]);
        }
    }
    ...
    public function displayProducts(){
        ...
        return view('admins.allproduct', compact('products'));
    }
    ...
    public function deleteProducts($id){
        ...
        if($product){
            ...
            return Redirect::route('all.products')->with(['delete'=>"product status deleted succesffully"]);
        }
    }
    ...
    public function deleteBooking($id){
        ...
        if($booking){
            ...
            return Redirect::route('all.bookings')->with(['delete'=>"booking status deleted succesffully"]);
        }
    }
}